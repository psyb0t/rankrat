...
#
# RANKRAT_READ_ONLY and RANKRAT_UNBOUNDED are the server's own settings, read
# here as well because they decide how the boundary file has to be mounted.
#
...
log INFO "starting rankrat mode=$mode image=$image read_only=$read_only unbounded=$unbounded"
